...
export default class extends Component {
  ...
  render() {
    return (
        <div className="container-full contianer-flex">
          <Header title="登录"/>
          <div className="login">
            ...
            <form action="/user/center" method="POST">
              <p style={{borderColor: this.state.userNameIsFocus ? '#e9203d' : '#b8b8b8'}}>
                ...
                <input type="text" placeholder="请输入用户名" onFocus={this.handleFocusUserName} onBlur={this.handleBlurUserName} onChange={this.handleChangeUserName} value={this.state.userName} />
              ...
              <p style={{borderColor: this.state.userPasswordIsFocus ? '#e9203d' : '#b8b8b8'}}>
                ...
                <input type="password" placeholder="请输入密码" onFocus={this.handleFocusUserPassWord} onBlur={this.handleBlurUserPassWord}
                  onChange={this.handleChangeUserPassWord} value={this.state.userPassword}/>
